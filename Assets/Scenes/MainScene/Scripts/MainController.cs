...
public class MainController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Загрузка последнего выбранного пользователем вида сортировки
        currentSortType = mainModel.LoadSortType();
        //Загрузка списка задач
        UserToDoList = mainModel.LoadData();
        //Размещение задач в представлении
        mainView.SpawnItems(UserToDoList);
        //Отображение задач в зависимости от статуса выполнения
    ...
    public void DeleteItem(ItemUI itemUI)
    {
        ...
        //Удаление из списка заспавненых задач теперь из представления
